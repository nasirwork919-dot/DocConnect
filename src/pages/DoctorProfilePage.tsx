        ...
        <Card className="p-6 shadow-[0_4px_14px_rgba(0,0,0,0.07)] bg-card-background rounded-2xl">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-2 mb-4">
                {doctor.qualifications.map((q, index) => (
                  <Badge 
                    key={index} 
                    variant="secondary" 
                    className="bg-primary-blue/10 text-primary-blue dark:bg-primary-blue/20 dark:text-primary-blue font-sans rounded-md"
                  >
                    {q}
                  </Badge>
                ))}
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto md:min-w-[200px]">
              <MotionButton 
                asChild 
                className="bg-primary-blue hover:bg-primary-blue/90 text-white w-full rounded-xl font-sans"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <h3 className="text-xl font-semibold mb-3 flex items-center font-michroma">
                <Languages className="h-5 w-5 mr-2 text-primary-blue" />
                Languages Spoken
              </h3>
              <div className="flex flex-wrap gap-2 mb-6">
                {doctor.languages.map((lang, index) => (
                  <Badge 
                    key={index} 
                    variant="outline" 
                    className="text-muted-text border-muted-text/50 font-sans rounded-md"
                  >
                    {lang}
                  </Badge>
                ))}
              ...
              <Card className="p-4 mb-6 bg-primary-blue/10 dark:bg-primary-blue/20 rounded-2xl">
                <CardContent className="p-0 font-sans">
                  <p className="flex items-center text-lg font-semibold text-heading-dark dark:text-gray-50">
                    <Clock className="h-5 w-5 mr-2 text-primary-blue" />
                    Current Status:
                    <Badge 
                      className={`ml-2 ${getStatusColor(doctor.realtimeStatus)} text-white font-sans rounded-md`}
                    >
